...
// WasmQuerySHA512_256 is a function from cryptQuery module. This function return sha512 256 hash.
func WasmQuerySHA512_256(this js.Value, args []js.Value) interface{} {
	if len(args) > 0 {
		value := args[0]
